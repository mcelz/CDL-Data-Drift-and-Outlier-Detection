import pandas as pd
import InjectSuddenDrift as isd
...
drifted_data_sudden = isd.inject_sudden_drift(data, target_variable, task_type, drift_type, instances_of_drift, magnitude_of_drift, drift_length)

drifted_data_sudden.to_csv("Gradual30high200.csv")